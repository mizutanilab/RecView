...
#define CDLGRESOLNPLOT_BITMAP_HEIGHT 190
#define CDLGRESOLNPLOT_BITMAP_WIDTH 280
...
protected:
	...
	int m_iCDLGRESOLNPLOT_BITMAP_HEIGHT;//230613
	int m_iCDLGRESOLNPLOT_BITMAP_WIDTH;
